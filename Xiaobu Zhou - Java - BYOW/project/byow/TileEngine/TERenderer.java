...
public class TERenderer {
     ...
     */
    public void renderFrame(byow.TileEngine.TETile[][] world) {
    ...
    /**
     * Since this method calls StdDraw.show() anyways, we create this and try to avoid double calling.
     *
     * @param world
     * @param message
     */
    public void renderFrame(byow.TileEngine.TETile[][] world, String message) {
        int numXTiles = world.length;
        int numYTiles = world[0].length;
        StdDraw.clear(new Color(0, 0, 0));
        for (int x = 0; x < numXTiles; x += 1) {
        ...
        // Show the message.
        StdDraw.text(3, numYTiles - 1, message);
